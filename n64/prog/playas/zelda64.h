...
/* Some math functions */
extern f32 sqrtf(f32 number);	/* 0x801031E0 */
extern f32 absf(f32 number);	/* 0x801067E0 */
extern f32 sinf(f32 angle);	/* 0x800FF690 */
extern f32 cosf(f32 angle);	/* 0x80103A10 */
extern f32 sins(u16 angle);	/* 0x800FF850 */
extern f32 coss(u16 angle);	/* 0x80103B80 */

/* Animation functions */
void changeAnimation(u32, u32 animationOffset); /* 0x800A52F8 */
/* 800A15C8 */
void renderFrame(u32 const_1, u32 hierarchy, u32 vals, u32 function_1, /* can be NULL */
		RamActor * actor, u32 function_2); /* can also be NULL */
