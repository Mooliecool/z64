...
void SetTextRGBA(u32 DList, u8 r, u8 g, u8 b, u8 a);
void SetTextXY(u32 DList, u16 x, u16 y);
void SetTextString(u32 DList, char * format, ...);
...
extern u16 sins(u16 angle);	/* 0x800FF850 */
extern u16 coss(u16 angle);	/* 0x80103B80 */
